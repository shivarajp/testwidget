 ...
 */
public class RecorderWidget4by1Provider extends AppWidgetProvider {

    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        Log.d("case", "onUpdate()4*1");
        ...
        for (int widgetId : appWidgetIds) {
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.recorder4by1_layout);
            views.setOnClickPendingIntent(R.id.start, pendingSettingsIntent);
